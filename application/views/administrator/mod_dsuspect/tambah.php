...
echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Data Suspectible Species</h3>
                </div>
              <div class='box-body'>";
$attributes = array('class' => 'form-horizontal', 'role' => 'form', 'autocomplete' => 'off');
echo form_open_multipart('administrator/tambah_dsuspect', $attributes);
echo "<div class='col-md-12'> ";
?>
<table class='table table-condensed table-bordered'>
    <tbody>
        ...
        <!-- <tr>
            <th width='120px' scope='row'>Kode Data Suspectible Species</th>
            <td><input type='text' class='form-control' name='a' required></td>
        </tr> -->
        <tr>
            <th width='120px' scope='row'>Nama Suspectible Species</th>
        ...
        <tr>
            <th width='120px' scope='row'>Suspectible Species</th>
            <td><select name="d" id="susceptible_species" class="form-control" required>
