           <section class="col-lg-12 connectedSortable">
             <div class='box'>
               <div class='box-header'>
                 <h3 align="center">DATA KARANTINA IKAN <br />
                   </h3>
               </div>
               <div class='box-body'>
                 <font size="4"><em>Data Karantina Ikan</em></font> <br />
                 <br />
                      ...
                      foreach($ta->result_array() as $row21)
                      {
                        ...
                        echo "<tr><td bgcolor='#A7D6EF'>$no</td>
                              ...
                              <td>$tingkatResiko</td>              							  	
              							  <td>$tindakanAkhir</td>
                              <td><center>
                                <a class='btn btn-warning btn-xs' title='PDF' href='" . base_url() . "administrator/exportExcel/$row[idKarantina]'><span class='glyphicon glyphicon'>Download</span></a>
                              </center></td>
                          </tr>";
                        $no++;
                      }
